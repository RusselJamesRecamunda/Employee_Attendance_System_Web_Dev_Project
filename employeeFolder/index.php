    ...
    
{
    ...
    $amInLimitTime = DateTime::createFromFormat('H:i', '07:00');
    ...
    // Calculate undertime minutes if AM Out time is before 11 AM
    $amOutUndertimeMinutes = 0;
    $amOutTime = DateTime::createFromFormat('H:i', $amOut);
    $amOutLimitTime = DateTime::createFromFormat('H:i', '11:00');
    ...
    // Calculate undertime minutes if PM Out time is before 5 PM
    $pmOutUndertimeMinutes = 0;
    $pmOutTime = DateTime::createFromFormat('H:i', $pmOut);
    $pmOutLimitTime = DateTime::createFromFormat('H:i', '17:00');
